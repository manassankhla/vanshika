...
<head>
    ...
    <title>Modern Villa - Architect Vanshika</title>
...
<body class="dark">
    ...
    <div id="smooth-wrapper">
        ...
        <div id="smooth-content">
            ...
            <!-- Project Detail Hero (Auto-populated by handler) -->
            <div class="project-hero-section section-padding pb-0 pt-150">
                <div class="container">
                    <div class="row justify-content-center text-center">
                        <div class="col-xl-8">
                            <h1 class="display-3 text-white mb-4">Loading...</h1>
                            <p class="mb-0 text-white-50 text-uppercase letter-spacing-2"></p>
                        </div>
                    </div>
                </div>
            </div>

            <!-- Project Images Slider (Auto-populated by handler) -->
            <div class="project-detail-gallery section-padding pt-50">
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-xl-10">
                            <!-- Main Slider -->
                            <div class="project-main-slider mb-4">
                                <!-- Dynamic Slides -->
                            </div>
                    ...
                    <div class="row mt-5">
                        <div class="col-12 text-center">
                            <a href="projects.html" class="view-project-btn">Back to Projects</a>
                        </div>
                    </div>
